...
module.exports.run = async (bot, message, args) => {
    ...
    .setColor("RANDOM")
    .setDescription(`<a:loading:732919805254041701> Generating a kitty!...`)
    let msg = await message.channel
      .send(loadingEmbed)
      .then(m => m.delete({ timeout: 2000 }));

    fetch("https://www.reddit.com/r/kitty/.json?sort=top&t=daily")
      .then(res => res.json())
      .then(body => {
...
module.exports.config = {
    name: 'kitty',
    description: 'Showing Random kitty',
    usage: `${bot.prefix}kitty`,
