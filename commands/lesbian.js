...
module.exports.run = async (bot, message, args) => {
    ...
    .setAuthor(`Lesbian Status!?`, member.user.displayAvatarURL())
    .setDescription(`${member.user.tag} is **${random}% Lesbian!**`)
    .setTimestamp()
    .setColor('RANDOM')
...
module.exports.config = {
    name: "lesbian",
    description: "Showing Your Lesbian Status",
    usage: `${botconfig.prefix}lesbian`,
