...
module.exports.run = async (bot, message, args) => {
    ...
    .setColor("RANDOM")
    .setDescription(`<a:loading:732919805254041701> Generating a fish!...`)
    let msg = await message.channel
      .send(loadingEmbed)
      .then(m => m.delete({ timeout: 2000 }));

    fetch("https://www.reddit.com/r/Fish/.json?sort=top&t=daily")
      .then(res => res.json())
      .then(body => {
...
module.exports.config = {
    name: 'fish',
    description: 'Showing Random fish',
    usage: `${bot.prefix}fish`,
