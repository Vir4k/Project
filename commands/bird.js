...
module.exports.run = async (bot, message, args) => {
    loadingEmbed = new Discord.MessageEmbed()
      .setColor("RANDOM")
      .setDescription(`<a:loading:732919805254041701> Generating a Bird Image!...`)
    let msg = await message.channel
      .send(loadingEmbed)
      .then(m => m.delete({ timeout: 2000 }));

    fetch("https://www.reddit.com/r/BirdsBeingDicks/.json?sort=top&t=daily")
      .then(res => res.json())
      .then(body => {
...
module.exports.config = {
    name: 'bird',
    description: 'Showing Random bird',
    usage: `${bot.prefix}bird`,
