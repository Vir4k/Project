...
module.exports.run = async (bot, message, args) => {
    ...
    .setColor("RANDOM")
    .setDescription(`<a:loading:732919805254041701> Generating a puppy!...`)
    let msg = await message.channel
      .send(loadingEmbed)
      .then(m => m.delete({ timeout: 2000 }));

    fetch("https://www.reddit.com/r/puppy/.json?sort=top&t=daily")
      .then(res => res.json())
      .then(body => {
...
module.exports.config = {
    name: 'puppy',
    description: 'Showing Random puppy',
    usage: `${bot.prefix}puppy`,
